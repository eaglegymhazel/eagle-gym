  ...
  return (
    <div className="relative inline-block" ref={containerRef}>
      <button
        ...
        className={`inline-flex min-w-[270px] items-center justify-between gap-4 rounded-2xl border border-[#ddd2ee] bg-white px-4 py-3 text-left shadow-[0_12px_28px_-18px_rgba(31,26,37,0.22)] transition ${
          hasOtherChildren
            ? "cursor-pointer hover:border-[#c8b6e6] hover:bg-[#fcf9ff]"
            : "cursor-default"
        }`}
      >
        <span className="flex min-w-0 flex-col">
        ...
        {hasOtherChildren ? (
          <span className="shrink-0 text-[#2a203c]/60" aria-hidden="true">
            ▾
          </span>
        ) : null}
      </button>
